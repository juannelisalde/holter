					...
					<div class="col-md-12">
						<form>
						  ...
						  <div class="form-group col-sm-4 col-md-3 col-lg-3">
						    <label for="exampleInputFile">Cargue de archivo</label>
						    <input type="file" id="exampleInputFile">
						    <p class="help-block">Subir archivo Excel</p>
						  </div>
						  <div class="form-group col-sm-4 col-md-2 col-lg-3">
						  	<br>
						  	<button type="button" class="btn btn-success"><i class="glyphicon glyphicon-import"></i> Importar Excel</button>
						  </div>
...
<!-- 			  			<form id="simdata" class="form-inline">
							  <div class="form-group">
							    <input type="number" class="form-control" id="fre_min" min="0" max="200" required placeholder="F. Mín" title="F. Mín"/>
							  </div>
							  <div class="form-group">
							    <input type="number" class="form-control" id="fre_max" min="0" max="200" required placeholder="F. Max" title="F. Max"/>
							  </div>
						  <button class="btn btn-primary" id="randomizeData">Simular</button>
						</form> -->
			  		</div>
				</div>
		    </div>
